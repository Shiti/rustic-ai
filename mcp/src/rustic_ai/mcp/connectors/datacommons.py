"""
Auto-generated Pydantic models for datacommons's MCP. Supported tools are:
get_observations : Fetches observations for a statistical variable from Data Commons.
   ...
   "tools": [
     {
       ...
       "input_class_name": "rustic_ai.mcp.connectors.datacommons.GetObservationsInput"
     },
     {
       "name": "search_indicators",
       "input_class_name": "rustic_ai.mcp.connectors.datacommons.SearchIndicatorsInput"
     }
   ]
 }
...
class SearchIndicatorsInput(BaseModel):
    ...
    per_search_limit: Optional[int] = 10
    include_topics: Optional[bool] = True
    maybe_bilateral: Optional[bool] = False
